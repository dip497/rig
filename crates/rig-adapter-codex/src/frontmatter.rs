...
//!
//! Intentionally duplicated from `rig-adapter-claude` — adapters must
//! not import each other. If this helper ever needs to be shared, lift
//! it to `rig-core` or `rig-fs`.
//!
//! We deliberately avoid a full YAML dependency. Codex (and Claude Code)
//! skill frontmatter is a flat map of string keys to string values (or
