...
//!
//! Claude Code only auto-reads `CLAUDE.md`, so rules live next to
//! `CLAUDE.md` as standalone files and the user `@imports` them. This
//! matches the convention in the dogfood setup (`~/.claude/rules/`).
